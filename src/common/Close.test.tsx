...
describe('Close component', () => {
  test('renders with default props', () => {
    ...
    expect(svgElement).toHaveAttribute('class', 'fill-gray-666');
    ...
    expect(pathElement).toHaveAttribute('d', 'm256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z')
  });

  test('renders with specified size', () => {
    const customSize = SvgSize.lg;
    render(<Close size={customSize} />);
  ...
  test('renders with specified className', () => {
    ...
    render(<Close className={customClass} />);
